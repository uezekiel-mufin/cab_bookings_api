...
# Reservation.create(reserve_date:'2023-07-07',user_id: 1, cab_id: 47, city: 'New York')
# Reservation.create(reserve_date:'2023-08-08',user_id: 3, cab_id: 49, city: 'London')
# Reservation.create(reserve_date:'2023-09-09',user_id: 1, cab_id: 50, city: 'Barcelona')
# Reservation.create(reserve_date:'2023-10-10',user_id: 3, cab_id: 50, city: 'Vietnam')
# Reservation.create(reserve_date:'2023-11-11',user_id: 1, cab_id: 51, city: 'Asaba')
# Reservation.create(reserve_date:'2023-12-12',user_id: 2, cab_id: 57, city: 'Vancover')
# Reservation.create(reserve_date:'2024-01-01',user_id: 1, cab_id: 54, city: 'Benin City')
# Reservation.create(reserve_date:'2023-07-07',user_id: 1, cab_id: 51, city: 'New York')
# Reservation.create(reserve_date:'2023-08-08',user_id: 1, cab_id: 49, city: 'London')
# Reservation.create(reserve_date:'2023-09-09',user_id: 2, cab_id: 59, city: 'Barcelona')
# Reservation.create(reserve_date:'2023-10-10',user_id: 1, cab_id: 59, city: 'Vietnam')
# Reservation.create(reserve_date:'2023-11-11',user_id: 2, cab_id: 56, city: 'Asaba')
# Reservation.create(reserve_date:'2023-12-12',user_id: 1, cab_id: 60, city: 'Vancover')
# Reservation.create(reserve_date:'2024-01-01',user_id: 3, cab_id: 60, city: 'Benin City')